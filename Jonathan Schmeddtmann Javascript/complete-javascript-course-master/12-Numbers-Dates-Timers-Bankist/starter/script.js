...
console.log(2 ** 53 + 3);
console.log(125434513518866888464667615n);
console.log(BigInt(12543451351));

// Operations
console.log(10000n + 10000n);
console.log(23764523874652837542835n * 82364872364872263n);

const huge = 873478236487236328n;
const num = 23;
...
// console.log(new Date('May 03 2022 09:56:09'));
// console.log(new Date('December 24 2015'));

// console.log(new Date(account1.movementsDates[0]));
// console.log(new Date(2037, 10, 33, 15, 23));
...
if (ingredients.includes('spinach')) {
  ...
  console.log(`Your pizza contains spinach`);
}
