...
const ShoppingCart2 = (function () {
  ...
  const addToCart = function (product, quantity) {
    ...
    console.log(
      `${quantity} ${product} added to cart (shipping cost is ${shippingCoast})`
    );
  };
  const orderStock = function (product, quantity) {
    console.log(`${quantity} ${product} ordered from suppliert`);
  };
...
console.log((0, _shoppingCartJs.cart).filter((el)=>el.quantity >= 2));
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iL2AH","6rimH"], "6rimH", "parcelRequire7e89")
